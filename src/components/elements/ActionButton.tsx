...
`
const ArrowTwo = styled.path`
  transition: 0.5s;
  transform: translateX(-30%);
`
const ArrowThree = styled.path``
...
const Button = styled.a<{
  ...
  :hover {
    ...
    ${ArrowOne} {
      ...
      animation: ${(props) =>
          props.contrast ? 'color_anim_contrast' : 'color_anim'}
        1s infinite 0.6s;
    }
    ${ArrowTwo} {
      transform: translateX(0%);
  ...
  span:nth-child(2) {
    width: 20px;
    margin-left: ${(props) => props.spanMargin};
    position: relative;
    top: 12%;
  }
  span {
